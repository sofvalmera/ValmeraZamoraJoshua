        ...
        <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="false">
            <div class="carousel-inner">
                <div class="carousel-item active">
                 ...
                 <div class="carousel-item">
                    ...
                    <picture>
                        ...
                        <source media="(min-width: 800px)" srcset="{{asset('front-assets/images/cat1.jpg')}}" />
               ...
               <!-- <div class="carousel-item">
                    ...
                    <picture>
                        <source media="(max-width: 799px)" srcset="{{asset('front-assets/images/front3.jpeg')}}" />
                        <source media="(min-width: 800px)" srcset="{{asset('front-assets/images/front3.jpg')}}" />
                        <img src="images/front1.jpeg" alt="" />
                    </picture>

                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3">
                            <h1 class="display-4 text-white mb-3">shopeeeeees</h1>
                            <p class="mx-md-5 px-5">Lorem rebum magna amet lorem magna erat diam stet. Sadips duo stet amet amet ndiam elitr ipsum diam</p>
                            <a class="btn btn-outline-light py-2 px-4 mt-3" href="{{route('front.shop')}}">Shop Now</a>
                        </div>
                    </div>
