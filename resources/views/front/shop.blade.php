                        ...
                        <div class="card-body">
                          ...
                          @foreach ($categories as $key => $category)
                            ...
                            @if($category->sub_category->isNotEmpty())
                                    ...
                                    @else
                                    <a href="{{route("front.shop",$category->slug)}}" class="nav-item nav-link  {{ ($categorySelected == $category->id) ? 'show' : ''}}">{{$category->name}}</a>
                                    ...
                                    @if($category->sub_category->isNotEmpty())
                                    <div id="collapseOn-{{ $key }}" class="accordion-collapse collapse {{ ($categorySelected == $category->id) ? 'show' : ''}}" aria-labelledby="headingOne" data-bs-parent="#accordionExample" style="">
                                        <div class="accordion-body">
                                            <div class="navbar-nav">
                                            @foreach ($category->sub_category as $subCategory)
                                                <a href="{{route("front.shop",[$category->slug,$subCategory->slug])}}" class="nav-item nav-link {{ ($subCategorySelected == $subCategory->id) ? 'show' : ''}}">{{$subCategory->name}}</a>
                                                @endforeach
